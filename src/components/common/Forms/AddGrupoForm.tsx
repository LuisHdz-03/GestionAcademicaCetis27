...
export default function AddGrupoForm({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.codigo || !formData.semestre || !formData.idPeriodo || 
        !formData.idDocente || !formData.idMateria || !formData.idEspecialidad) {
    ...
    <form className="space-y-3" onSubmit={handleSubmit}>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-md p-3 mb-3">
        <p className="text-sm text-blue-800">
          <strong>Nota:</strong> Asegúrate de tener periodos, especialidades, docentes y materias creados antes de agregar un grupo.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Input name="codigo" value={formData.codigo} onChange={handleChange} required placeholder="Ej: 1A, 2B, 3C" />
        </div>
        <div>
      ...
      <div>
        ...
        <Input name="aula" value={formData.aula} onChange={handleChange} placeholder="Ej: A-101, B-205" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Select 
            ...
            value={formData.idPeriodo && formData.idPeriodo > 0 ? formData.idPeriodo.toString() : undefined}
          >
            <SelectTrigger>
            ...
            <SelectContent>
              {periodos.length === 0 ? (
                <SelectItem value="0" disabled>No hay períodos disponibles</SelectItem>
              ) : (
        ...
        <div>
          ...
          <Select 
            ...
            value={formData.idEspecialidad && formData.idEspecialidad > 0 ? formData.idEspecialidad.toString() : undefined}
          >
            <SelectTrigger>
            ...
            <SelectContent>
              {especialidades.length === 0 ? (
                <SelectItem value="0" disabled>No hay especialidades disponibles</SelectItem>
              ) : (
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Select 
            ...
            value={formData.idDocente && formData.idDocente > 0 ? formData.idDocente.toString() : undefined}
          >
            <SelectTrigger>
            ...
            <SelectContent>
              {docentes.length === 0 ? (
                <SelectItem value="0" disabled>No hay docentes disponibles</SelectItem>
              ) : (
        ...
        <div>
          ...
          <Select 
            ...
            value={formData.idMateria && formData.idMateria > 0 ? formData.idMateria.toString() : undefined}
          >
            <SelectTrigger>
            ...
            <SelectContent>
              {materias.length === 0 ? (
                <SelectItem value="0" disabled>No hay materias disponibles</SelectItem>
              ) : (
      ...
      <Button type="submit" className="w-full bg-[#691C32] hover:bg-[#691C32]/90 text-white mt-4">
